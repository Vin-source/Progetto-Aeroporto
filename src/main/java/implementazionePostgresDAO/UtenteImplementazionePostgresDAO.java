...
public class UtenteImplementazionePostgresDAO implements UtenteDAO {
     ...
     * Il metodo recupera anche i posti in aereo e i dati sui bagagli
     * associati alle singole prenotazioni
     *
    ...
    public ArrayList<Prenotazione> getPrenotazioniDB(String email_utente) throws SQLException {
        ...
        String sql3 = "SELECT * FROM bagaglio WHERE id_prenotazione = ? ";
            ...
            try(PreparedStatement prenotazioniSQL = connection.prepareStatement(sql)){
                ...
                while(prenotazioni.next()){
                    ...
                    try(PreparedStatement postoDB = connection.prepareStatement(sql2)){
